...
async function fixWebhook() {
    ...
    try {
        console.log("Tentando /webhook/set (Formato Flat)...");
        ...
        console.log("\nTentando via Instance Config...");
        const response2 = await fetch(`${EVOLUTION_API_URL}/instance/setWebhook/${INSTANCE_NAME}`, {
            method: "POST",
        ...
        console.log(`Status /instance/setWebhook: ${response2.status}`);
